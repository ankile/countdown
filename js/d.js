...
// Get the query string and split into birthdate and years of life
var query = window.location.search;
query = query.split('&');

// Get time in milliseconds from epoch to birthdate
var birth = new Date(query[0].substring(1, 11)).getTime();

// Extract and convert the amount of years from the query string
var yearsOfLife = parseInt(query[1]);

// Get the year of birth
var birthYear = parseInt(query[0].substring(1, 5));
...
var newDateTimeString = deathYear + query[0].substring(5, 11);
